document.addEventListener('DOMContentLoaded', () => {
    ...
    if (bookingForm) {
        ...
        // Seleção flexível do botão de envio
        const submitBtn = bookingForm.querySelector('button[type="submit"], button, input[type="submit"]');

        // Data local precisa (YYYY-MM-DD) sem bugs de UTC
        const now = new Date();
        ...
        bookingForm.addEventListener('submit', (e) => {
            ...
            // Animação de carregamento e exibição do feedback
            if (submitBtn) {
                const originalBtnContent = submitBtn.innerHTML || submitBtn.value;
                ...
                if (submitBtn.tagName === 'INPUT') {
                    submitBtn.value = 'Processando reserva...';
                } else {
                    submitBtn.innerHTML = `
    ...
    function showSuccessFeedback(form) {
        ...
        // Estilização direta garantida para aparecer independente de CSS externo
        ...
        feedback.innerHTML = `
            ...
            <h4 style="color: #FFFFFF; font-family: 'Cormorant Garamond', serif; font-size: 1.25rem; margin: 0 0 6px 0; font-weight: 500;">Solicitação Recebida com Sucesso</h4>
            <p style="color: rgba(255, 255, 255, 0.9); font-size: 0.88rem; margin: 0; line-height: 1.5;">
        ...
        // Rola a tela suavemente para a mensagem caso ela fique cortada na parte inferior
